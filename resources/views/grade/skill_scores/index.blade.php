            ...
            <x-table header="Header Content" :sidebarOpen="$sidebarOpen" class="overflow-x-auto mx-auto">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <x-edit-primary-button tag="a" :href="route('grade.skill_scores.edit', ['assessment_type' => $assessmentType->assessment_type])"
                        ...
                        x-on:click.prevent="
                            ...
                            $dispatch('set-action', '{{ route('grade.skill_scores.destroy', ['assessment_type' => $assessmentType->assessment_type]) }}');"
                        class="flex items-center justify-center min-w-[60px]">
