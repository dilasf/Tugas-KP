        ...
        <div class="bg-white overflow-hidden shadow-sm">
            <div class="p-6 text-black dark:text-gray-100">
                <div class="max-h-[70vh] overflow-y-auto">
                    <form method="post" action="{{ route('grade.storeKnowledgeScore', ['studentId' => $student->id]) }}" enctype="multipart/form-data" class="mt-6 space-y-6">
                        @csrf
                        <div class="max-w-3xl">
                            <x-input-label for="assessment_type" value="Jenis Penilaian" />
