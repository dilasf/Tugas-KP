        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form action="{{ route('grade.updateAttitudeScore', ['studentId' => $studentId, 'classSubjectId' => $classSubjectId, 'semesterYearId' => $defaultSemesterYearId, 'assessmentType' => $assessmentType]) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="flex justify-end space-x-4 mt-4 w-full">
                                <a href="{{ route('grade.detailAttitudeScore', ['studentId' => $studentId, 'classSubjectId' => $classSubjectId, 'semesterYearId' => $defaultSemesterYearId]) }}"
