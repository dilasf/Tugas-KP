                ...
                <div class="max-h-[70vh] overflow-y-auto">
                    <form method="post" action="{{ route('grade.attitude_scores.store') }}" class="mt-6 space-y-6">
                        ...
                        <div class="flex justify-end space-x-4 mt-4 w-full">
                            <x-secondary-button tag="a" href="{{ route('grade.attitude_scores.index') }}">Batal</x-secondary-button>
