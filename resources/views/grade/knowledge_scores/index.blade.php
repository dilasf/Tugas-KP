                ...
                @php $num=1; @endphp
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <x-edit-primary-button tag="a" :href="route('grade.knowledge_scores.edit', ['assessment_type' => $assessmentType->assessment_type])"
                                ...
                                x-on:click.prevent="
                                    ...
                                    $dispatch('set-action', '{{ route('grade.knowledge_scores.destroy', ['assessment_type' => $assessmentType->assessment_type]) }}');"
                                class="flex items-center justify-center min-w-[60px]">
