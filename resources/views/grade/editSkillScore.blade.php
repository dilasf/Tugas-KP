    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-10">
        ...
        <div class="bg-white overflow-hidden shadow-sm">
            <div class="p-6 text-black">
                    <form method="POST" action="{{ route('grade.updateSkillScore', ['studentId' => $student->id, 'classSubjectId' => $classSubject->id, 'assessmentType' => $assessmentType, 'semesterYearId' => $semesterYear->id]) }}">
                        @csrf
                        @method('PATCH')
