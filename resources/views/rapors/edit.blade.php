{{-- <x-app-layout>
    <x-slot name="header">
        <div class="flex items-center">
            {{-- <a href="{{ route('rapors.index',  ['id' => $student->id]) }}">
                <img src="{{ asset('img/back_logo.png') }}" class="w-[30px] h-[30px] mr-3 cursor-pointer">
            </a> --}
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Edit Nilai Keterampilan - {{ $rapor->grade->classSubject->subject->subject_name }} ({{ $rapor->grade->semesterYear->semester }})
            </h2>
...
<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Edit Nilai untuk {{ $classSubject->subject->subject_name }} (Semester {{ $semesterYear->semester }} Tahun {{ $semesterYear->year }})
            </h2>
        </div>
    </x-slot>
