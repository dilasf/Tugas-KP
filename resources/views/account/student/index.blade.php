<x-app-layout>
    ...
    <div class="bg-white rounded-lg shadow-md mx-4 overflow-hidden">
        ...
        <x-table header="Daftar Akun Siswa" :sidebarOpen="$sidebarOpen" class="overflow-x-auto mx-auto">
            ...
            <tr class="text-center">
                ...
                <td :class="{ 'flex flex-row justify-center items-center gap-2': sidebarOpen, 'justify-center items-center gap-2': !sidebarOpen }">
                    {{-- <x-edit-primary-button tag="a" href="{{ route('account.edit', ['id' => $account->id]) }}"
                    ...
                    <x-danger-button
                        x-data=""
                        x-on:click.prevent="
                            $dispatch('open-modal', 'confirm-account-deletion');
                            $dispatch('set-action', '{{ route('account.destroy', $account->id) }}');"
                        class="flex items-center justify-center min-w-[60px]">
        ...
        <x-modal name="confirm-account-deletion" focusable maxWidth="xl">
