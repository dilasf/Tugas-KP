<x-app-layout>
    ...
    <div class="bg-white rounded-lg shadow-md mx-4 overflow-hidden min-w-[300px] min-h-[500px]">
        <div class="flex justify-end px-6 py-4">
            <x-primary-button tag="a" href="{{route('subject.semester_year.create')}}">
                <span class="text-12px ml-1">{{ __('+ Tambah Semester&Tahun Ajaran') }}</span>
            </x-primary-button>
        </div>
        <div class="text-black max-h-[calc(100vh-200px)] overflow-y-auto">
                ...
                <tr class="text-center">
                    ...
                    <td :class="{ 'flex flex-row justify-center items-center gap-2': sidebarOpen, 'justify-center items-center gap-2': !sidebarOpen }">
                        ...
                        <x-danger-button
                            x-data=""
                            x-on:click.prevent="
                                $dispatch('open-modal', 'confirm-semester_year-deletion');
                                $dispatch('set-action', '{{ route('subject.semester_year.destroy', $TA->id) }}');"
                            class="flex items-center justify-center min-w-[60px]">
            ...
            <x-modal name="confirm-semester_year-deletion" focusable maxWidth="xl">
