     ...
     <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
      <ul class="space-y-1.5">
        ...
        <div class="px-8 py-1.5">
              <a class="flex-none text-sm font-semibold text-white focus:outline-none focus:ring-1 focus:ring-gray-600" href="#" aria-label="MASTER DATA">MASTER DATA</a>
         </div>
        ...
        <li class="hs-accordion" id="users-accordion">
          ...
          <div id="users-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden">
            <ul class="hs-accordion-group ps-3 pt-2" data-hs-accordion-always-open>
                ...
                <li>
                    <x-nav-link :href="route('teacher_data.index')" :active="request()->routeIs('teacher')">
        ...
        <div class="px-8 py-1.5">
            <a class="flex-none text-sm font-semibold text-white focus:outline-none focus:ring-1 focus:ring-gray-600" href="#" aria-label="SAYA">SAYA</a>
       </div>
