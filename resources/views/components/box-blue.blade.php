...
<div class="bg-semi-blue text-white p-5 mb-0" style="width: 259px; height: 110px;">
...
@if($tag == 'a')
    <a {{ $attributes->merge([
        ...
        text-white tracking-widest hover:bg-semi-blue focus:bg-dark-blue
...
@else
    <button {{ $attributes->merge([
        ...
        hover:bg-semi-blue focus:bg-dark-blue active:bg-dark-blue focus:outline-none
