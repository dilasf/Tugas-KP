...
<div class="bg-red-600 text-white p-5 mb-0" style="width: 259px; height: 110px;">
...
@if($tag == 'a')
    <a {{ $attributes->merge([
        ...
        px-2 py-1 sm:px-3 sm:py-2 md:px-4 md:py-2 bg-red-700 border
        border-transparent font-semibold text-xs sm:text-xs md:text-sm
        text-white tracking-widest hover:bg-red-600 focus:bg-red-700
        active:bg-red-700 focus:outline-none transition ease-in-out duration-150'
    ]) }} href="{{ $href }}">
...
@else
    <button {{ $attributes->merge([
        ...
        sm:px-3 sm:py-2 md:px-4 md:py-2 bg-red-700 border border-transparent
        font-semibold text-xs sm:text-xs md:text-sm text-white tracking-widest
        hover:bg-red-600 focus:bg-red-700 active:bg-red-700 focus:outline-none
