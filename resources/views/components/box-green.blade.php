...
<div class="bg-semi-green text-white p-5 mb-0" style="width: 259px; height: 110px;">
...
@if($tag == 'a')
    <a {{ $attributes->merge([
        ...
        px-2 py-1 sm:px-3 sm:py-2 md:px-4 md:py-2 bg-semi-dark-green border
        border-transparent font-semibold text-xs sm:text-xs md:text-sm
        text-white tracking-widest hover:bg-semi-green focus:bg-semi-dark-green
        active:bg-semi-dark-green focus:outline-none transition ease-in-out duration-150'
    ]) }} href="{{ $href }}">
...
@else
    <button {{ $attributes->merge([
        ...
        sm:px-3 sm:py-2 md:px-4 md:py-2 bg-semi-dark-green border border-transparent
        font-semibold text-xs sm:text-xs md:text-sm text-white tracking-widest
        hover:bg-semi-green focus:bg-semi-dark-green active:bg-semi-dark-green focus:outline-none
